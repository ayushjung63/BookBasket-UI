  ...
  custom_file_upload_url = 'http://localhost:8085/api/upload';
   ...
   handleImagePreview = (e) => {
	...
	handleSubmit=(event)=>{
		event.preventDefault();
		var date=Date.now()
		addBook(this.state.title,this.state.author,this.state.price,this.state.category,this.state.description,this.state.delivery,this.state.img,this.state.type,this.state.user.id,3).then((res)=>{
		    console.log(this.state.img)
                        ...
                        <div class=""> 
                                                    ...
                                                    <form  class="" onSubmit={(event)=>this.handleSubmit(event)}>
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="text" class="formData" placeholder="Book Title" name="title" autofocus required onChange={(e)=>this.handleChange(e)} />
                                                          </p>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="form-group mb-4">
                                                               <p className="formInfo">Book Author<br/>
                                                                    ...
                                                                    <input type="text" placeholder="Book Author" class="formData" name="author" required  onChange={(e)=>this.handleChange(e)}/>
                                                              </p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-group mb-4">
                                                               ...
                                                               <br />
                                                                    <input type="text" placeholder="Book Price" class="formData" name="price" required onChange={(e)=>this.handleChange(e)}/>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-group mb-4">
                                                                <p className="formInfo">Book Description<br/>
                                                                    ...
                                                                    <input onChange={(e)=>this.handleChange(e)} type="textarea" placeholder="Book Description" class="formData"  name="description" required />
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <button type="submit" class="formBtn">Add Book</button>
                                                  </p>
                                                </form>
                                            </div>
                                </main>
